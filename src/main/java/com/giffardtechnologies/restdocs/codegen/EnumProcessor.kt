...
//            return builder.build()
    ...
    private fun processEnumToSealedTypeSpec(
        ...
        val builder = TypeSpec.classBuilder(enumClassName).addModifiers(KModifier.SEALED)
            ...
            .addSuperinterface(
                superinterface = ClassName("com.allego.api.client.support.futureproof", "EnumID").parameterizedBy(enumKeyTypeClass.asClassName()),
                delegate = CodeBlock.of("%T(id)", ClassName("com.allego.api.client.support.futureproof", "ImmutableEnumID"))
            )
            .addAnnotation(
